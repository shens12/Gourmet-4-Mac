...
export default function Homepage() {
  ...
  return (
	...
	<div className="group1">
			<br />
			<img className="subgroup1" src="https://shens12.github.io/Gourmet-4-Mac/Foodicon1.png" alt="Foodicon1" /> 
			<div className="subgroup2">
			<p className="title1">Find your favorite, dine on campus</p> 
			<SearchBar />
			<br />
			</div>
			<img className="subgroup3" src="https://shens12.github.io/Gourmet-4-Mac/Foodicon2.png" alt="Foodicon2" /> 			
		</div>
		<div className="group2">
			...
			<div className="subgroup4">
				<Link to="/report">
					<img className="img" src="https://shens12.github.io/Gourmet-4-Mac/report.png" alt="Report" /> 
					<p className="clickable"> Report an issue <img width="20" src="https://shens12.github.io/Gourmet-4-Mac/triangle1.png" /></p>
				</Link>
			...
			<div className="subgroup4">
				<Link to="/mobile">
					<img className="img" src="https://shens12.github.io/Gourmet-4-Mac/mobile.png" alt="Mobile" /> 	
					<p className="clickable"> Try on mobile <img width="20" src="https://shens12.github.io/Gourmet-4-Mac/triangle1.png" /></p>
					</Link>
				<p className="desc"> Try using our web app <br />
				on your device to gain<br />
				more convenience  </p>
			</div>
			<img className="cl" src="https://shens12.github.io/Gourmet-4-Mac/click.png" alt="Click below" /> 	
		</div>
		<div className="group1">
