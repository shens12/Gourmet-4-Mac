                ...
                <div className="desc2">
                    <div className="subgroup5">
						...
						<div className="subgroup8">
							...
							<p className="desc4"> Sit back and wait for your fellow McMaster students deliver to your door </p> 
						</div>
					</div>
					<div className="subgroup6">
						<Link to={"/rate/" + product._id}><img className="subgroup6" src="https://shens12.github.io/Gourmet-4-Mac/rate.png" /></Link>
						<div className="subgroup8">
							<Link to={"/rate/" + product._id}><p className="clickable2"> Rate your experience <img width="20" src="https://shens12.github.io/Gourmet-4-Mac/triangle.png" /></p></Link>
